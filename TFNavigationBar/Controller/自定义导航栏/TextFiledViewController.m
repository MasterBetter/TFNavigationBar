...
@interface TextFiledViewController () <UITableViewDelegate, UITableViewDataSource>
...
- (void)viewDidLoad
{
    ...
    UITextField *textField = [[UITextField alloc] initWithFrame:CGRectMake(0, 5, [UIScreen mainScreen].bounds.size.width-120, 30)];
    textField.placeholder = @"请输入文字";
    textField.backgroundColor = [UIColor whiteColor];
    textField.borderStyle = UITextBorderStyleRoundedRect;
    textField.textAlignment = NSTextAlignmentCenter;
    self.customNavBar.centerView = textField;
